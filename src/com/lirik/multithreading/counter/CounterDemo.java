...
public class CounterDemo {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Из-за многопоточности значение счетчика может колебаться (в идеале оно должно быть 2700), так как операция инкремента не
         * атомарная (то есть сначала считывается значение, потом изменяется и только потом записывается)
         */
