package com.lirik.multithreading.list;
...
public class ListDemo {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Подобная конструкция используется, когда коллекция уже создана и ее нельзя изменить. На практике такой метод синхронизации
         * коллекций используется крайне редко!!!
         */
